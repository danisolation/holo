...
- [x] 97-02-PLAN.md — Frontend AI coverage stats card on dashboard
...
**Plans**: 1 plan
Plans:
- [x] 100-01-PLAN.md — MarketBreadthService + schemas + GET /api/market/breadth + tests
...
- [x] 102-02-PLAN.md — Breadth tab (A/D, MA breadth, highs/lows charts) + Dòng tiền tab (radar, flow summary)
**UI hint**: yes
...
**Plans**: 2 plans
Plans:
- [x] 105-01-PLAN.md — API types, hooks, and screener page with filters + sortable table
- [x] 105-02-PLAN.md — Sector detail page with performance chart + peer comparison radar
**UI hint**: yes
...
**Plans:** 2 plans
Plans:
- [ ] 109-01-PLAN.md — Backend: SimulatorReviewService + comparison endpoint + tests
...
| 109. AI Review + Performance Comparison | 0/2 | Not started | - |