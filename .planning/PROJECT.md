...
(Defining requirements for v6.0)

## Current Milestone: v6.0 AI Backtesting Engine

**Goal:** Backtest hệ thống AI trên dữ liệu lịch sử 6 tháng (120 phiên) cho 400+ mã, gọi Gemini phân tích thật tại mỗi phiên, mô phỏng mở/đóng lệnh, tổng kết P&L so sánh với VN-Index.

**Target features:**
- Backtest engine: duyệt từng phiên lịch sử, gọi Gemini AI, mở/đóng lệnh ảo theo tín hiệu
- Portfolio simulation: vốn ban đầu, position sizing, SL/TP/timeout
- Benchmark: equity curve AI vs VN-Index buy-and-hold
- Dashboard riêng (/backtest): equity chart, drawdown, win rate, thống kê theo ngành/timeframe
- Config: chọn khoảng thời gian, vốn khởi điểm, slippage
- Checkpoint/resume: lưu tiến trình backtest, tiếp tục nếu bị gián đoạn
...
---
*Last updated: 2025-07-21 — v6.0 milestone started*