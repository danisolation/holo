...
## Current Milestone: v22.0 Platform Polish & AI Coverage

**Goal:** Nâng cấp toàn diện — mở rộng AI analysis coverage, tăng cường simulator, cải thiện data quality & test, và polish UX/performance cho dashboard.

**Target features:**
- AI Analysis Coverage — Chạy AI regular cho nhiều ticker hơn (~190 → 400), schedule auto-analysis
- Simulator Enhancement — Auto-sell khi hit SL/TP, portfolio history chart, P&L timeline, sell signals
- Data Quality — Fix pre-existing test failures, thêm tests cho simulator, data integrity checks
- Performance/UX — Dashboard loading states, mobile responsive polish, page transitions
