...
(Defining requirements for v5.0)

## Current Milestone: v5.0 E2E Testing & Quality Assurance

**Goal:** Dùng Playwright tự động test toàn bộ ứng dụng — phát hiện bug, verify mọi flow E2E, visual regression, đảm bảo chất lượng.

**Target features:**
- Setup Playwright với cấu hình phù hợp Next.js + FastAPI
- E2E test mọi trang chính: Dashboard, Ticker, Watchlist, Portfolio, Paper Trading, Health
- API health check tests — verify tất cả endpoints
- Critical user flow tests: xem ticker → follow signal → paper trade → analytics
...
---
*Last updated: 2025-07-20 — v5.0 milestone started*