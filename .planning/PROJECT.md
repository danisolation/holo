...
## Current Milestone: v18.0 Multi-Source Community Rumors

**Goal:** Mở rộng nguồn tin đồn cộng đồng (Telegram groups + StockTraders.vn) và cải thiện AI phân tích rumor.

**Target features:**
- Crawl Telegram groups chứng khoán VN (public channels/groups)
- Crawl StockTraders.vn discussions/threads
- Cải thiện AI rumor scoring — aggregate từ nhiều nguồn
- Dashboard hiển thị rumor từ tất cả nguồn với source tagging
...
(Defining requirements for v17.0)

## Current Milestone: v17.0 AI Consistency & UX

**Goal:** Sửa AI phân tích nhất quán (không mâu thuẫn giữa các phần) + chỉ hiển thị hướng recommended + fix giá real-time trên Render.

**Target features:**
- Sửa COMBINED prompt: bắt buộc nhất quán với technical/fundamental signals
- Sửa TRADING_SIGNAL: output rõ ràng 1 hướng recommended, bỏ hướng thứ yếu
- Frontend: chỉ show recommended direction panel
- Fix VNDirect WebSocket connectivity trên Render
