...
## Current Milestone: v24.0 Sector Screening & Comparison

**Goal:** Nâng cao tính năng sector — phân loại chi tiết, screener theo ngành, so sánh cổ phiếu cùng ngành, AI peer analysis.

**Target features:**
- Sector Screener — lọc cổ phiếu theo ngành/industry với các bộ lọc (P/E, volume, % change)
- Peer Comparison — so sánh cổ phiếu cùng ngành (bảng + radar chart)
- Sector Detail Page — trang chi tiết ngành với danh sách mã, biểu đồ performance
- AI Peer Analysis — Gemini so sánh cổ phiếu với peer cùng ngành
