...
## Current Milestone: v20.0 Enhanced Price Pipeline

**Goal:** Cải thiện toàn bộ cơ chế giá — poll nhanh hơn, hoạt động liên tục, lưu trữ vào DB, tự động crawl khi thị trường đóng cửa.

**Target features:**
- Poll nhanh hơn (10-15s thay vì 30s)
- Poll cả ngoài giờ giao dịch (luôn có giá mới nhất trong cache)
- Lưu real-time price vào DB (không chỉ RAM cache)
- Tự động crawl batch ngay khi market đóng cửa (14:45)
...
(Defining requirements for v20.0)
