...
**Shipped:** v1.0 (2026-04-15), v1.1 (2026-04-17), v2.0 (2026-04-17), v3.0 (2026-04-20), v4.0 (2025-07-20), v9.0 (2026-05-04), v10.0 (2026-05-05), v11.0 (2026-05-05), v12.0 (2026-05-05), v13.0 (2026-05-05), v17.0
**Code:** ~30,000+ LOC (Python + TypeScript)
**Tests:** 545 backend unit tests
**Stack:** FastAPI + PostgreSQL + APScheduler + WebSocket + Google Gemini + python-telegram-bot + Next.js + lightweight-charts + Recharts

## Current Milestone: v23.0 Sector Rotation & Market Breadth

**Goal:** Phân tích dòng tiền ngành và sức khỏe thị trường HOSE — sector heatmap, market breadth indicators, rotation radar, và AI sector recommendation.

**Target features:**
- Sector Heatmap — bản đồ nhiệt theo ngành (% change, volume, market cap)
- Market Breadth — A/D line, % stocks above MA50/MA200, new highs vs lows
- Dòng tiền ngành — net buying/selling theo sector, rotation radar chart
- AI Sector Recommendation — Gemini phân tích ngành strong/weak + rotation timing
