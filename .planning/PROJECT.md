...
**Shipped:** v1.0 (2026-04-15), v1.1 (2026-04-17), v2.0 (2026-04-17), v3.0 (2026-04-20), v4.0 (2025-07-20), v9.0 (2026-05-04), v10.0 (2026-05-05)
...
(Defining requirements for v11.0)

## Current Milestone: v11.0 UX & Reliability Overhaul

**Goal:** Sửa các thiếu sót thực tế về trải nghiệm người dùng, data freshness, AI timeliness, và performance trên production.

**Target features:**
- Keep-alive service — Ping Render.com liên tục để tránh sleep, giảm cold start
- Search fix — Sửa tìm kiếm cổ phiếu để tìm được tất cả mã
- AI analysis refresh — Chạy phân tích AI thường xuyên hơn, đảm bảo data luôn fresh
- UX/Onboarding improvement — Trang chủ rõ ràng hơn, tính năng tường minh, người mới dễ hiểu
- API performance — Tối ưu load time trên production (hiện ~3 phút quá chậm)
...
---
*Last updated: 2026-05-05 — v11.0 milestone started*