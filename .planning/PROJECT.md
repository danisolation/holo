...
## Current Milestone: v19.0 Unified AI Analysis Pipeline

**Goal:** Gộp toàn bộ phân tích AI (kỹ thuật, cơ bản, sentiment, tin đồn, trading signal) thành 1 prompt duy nhất cho ra 1 kết quả đồng nhất — loại bỏ mâu thuẫn giữa các module.

**Target features:**
- Unified AI prompt: 1 call Gemini nhận ALL data → ra recommendation (mua/bán/giữ) + entry/SL/TP + reasoning
- Xóa code và DB cũ: bỏ 5 analysis types riêng lẻ (technical, fundamental, sentiment, combined, trading_signal)
- Redesign ticker detail page: 1 panel analysis duy nhất thay vì tabs riêng
- Cải thiện prompt quality: reasoning rõ ràng, không mâu thuẫn nội tại
...
(Defining requirements for v19.0)
