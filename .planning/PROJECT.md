...
**Shipped:** v1.0 (2026-04-15), v1.1 (2026-04-17), v2.0 (2026-04-17), v3.0 (2026-04-20), v4.0 (2025-07-20), v9.0 (2026-05-04)
...
(Defining requirements for v10.0)

## Current Milestone: v10.0 Watchlist-Centric & Stock Discovery

**Goal:** Chuyển Holo từ "hiển thị 400 mã cố định" sang "watchlist là trung tâm" — AI scan toàn sàn gợi ý mã tiềm năng hàng ngày, user tự chọn thêm vào watchlist, mọi thứ (AI analysis, daily picks, heatmap) chỉ chạy trên watchlist.

**Target features:**
- AI Stock Discovery — scan ~400 mã hàng ngày (kỹ thuật + cơ bản), gợi ý mã tiềm năng trên trang Discovery riêng
- Watchlist làm trung tâm — AI analysis, daily picks, dashboard chỉ chạy trên mã user đã chọn
- Trang Discovery — hiển thị gợi ý mã mới, user bấm thêm vào watchlist
- Heatmap rework — chỉ hiện watchlist, phân theo nhóm ngành user đã gán
- Nhóm ngành — user gán sector/tag cho mỗi mã trong watchlist
...
---
*Last updated: 2026-05-04 — v10.0 milestone started*