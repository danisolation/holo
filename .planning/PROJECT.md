...
(Defining requirements for v8.0)

## Current Milestone: v8.0 AI Trading Coach

**Goal:** Biến Holo thành huấn luyện viên trading cá nhân — mỗi ngày gợi ý cụ thể mua mã nào, ghi nhận kết quả, học từ thói quen, và điều chỉnh chiến lược theo thời gian.

**Target features:**
- Daily Picks: AI chọn 3-5 mã cụ thể mỗi ngày với giá vào + mức cắt lỗ + giải thích lý do
- Trade Journal: Người dùng nhập lệnh mua/bán thực tế, app tính lãi/lỗ tự động
- Behavior Tracking: Ghi nhận thói quen (mã hay xem, thời điểm giao dịch, patterns)
- Adaptive Strategy: Điều chỉnh gợi ý dựa trên kết quả — lỗ nhiều thì gợi ý an toàn hơn
- Goal & Review: Đặt mục tiêu lãi/tháng, track tiến độ, weekly review hỏi mức rủi ro
...
---
*Last updated: 2026-04-23 — v8.0 milestone started*