...
**Shipped:** v1.0 (2026-04-15), v1.1 (2026-04-17), v2.0 (2026-04-17), v3.0 (2026-04-20), v4.0 (2025-07-20), v9.0 (2026-05-04), v10.0 (2026-05-05), v11.0 (2026-05-05)
...
(Defining requirements for v12.0)

## Current Milestone: v12.0 Rumor Intelligence

**Goal:** Crawl tin đồn từ cộng đồng chứng khoán VN (Fireant.vn, CafeF forum), dùng Gemini AI đánh giá độ tin cậy và tác động, hiển thị rumor score riêng biệt trên dashboard.

**Target features:**
- Crawl Fireant.vn + CafeF forum cho watchlist tickers
- Gemini AI đánh giá rumor (credibility, impact, bullish/bearish)
- Rumor score riêng biệt trên ticker detail page
- Rumor feed timeline + badge trên watchlist table
- Scheduled crawl tích hợp vào pipeline hiện tại
