...
(Defining requirements for v7.0)

## Current Milestone: v7.0 Consolidation & Quality Upgrade

**Goal:** Audit toàn diện → xóa code dư thừa, gộp logic chồng chéo, nâng cấp AI validation và UX — giảm LOC, tăng maintainability và trải nghiệm dùng.

**Target features:**
- Xóa dead features (price_alert, unused columns, dead components)
- Gộp duplicate code (analytics services, trade tables, charts, schemas, utilities)
- Refactor architecture (AIAnalysisService → 4 class, BacktestEngine → modular)
- Nâng cấp AI validation (anti-hallucination, score-signal check)
- Cải thiện UX (consolidate watchlist, phân vai pages, clarify paper-trading vs backtest)
- Tối ưu performance (WebSocket off-hours, chart lazy-loading)
...
- Backtesting engine — ✓ Shipped v6.0 (moved from Out of Scope)
...
---
*Last updated: 2026-04-22 — v7.0 milestone started*