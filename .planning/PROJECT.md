...
**Shipped:** v1.0 (2026-04-15), v1.1 (2026-04-17), v2.0 (2026-04-17), v3.0 (2026-04-20)
**Code:** ~27,350 LOC (18,676 Python + 8,676 TypeScript)
**Tests:** 424 backend unit tests
...
(Defining requirements for v4.0)

## Current Milestone: v4.0 Paper Trading & Signal Verification

**Goal:** Giả lập trading để kiểm chứng chất lượng tư vấn AI — auto-track mọi signal + cho phép mở lệnh ảo thủ công, với full analytics dashboard.

**Target features:**
- Auto-track: Mọi AI trading signal tự động thành lệnh ảo
- Manual paper trading: Chọn signal, follow, tùy chỉnh entry/SL/TP
- Partial TP: 50% tại TP1 (dời SL→breakeven), 50% tại TP2
- Timeout: Hết timeframe → đóng theo giá thị trường
- Vốn giả lập tùy chỉnh, position sizing theo AI recommendation
- Full analytics: Win rate, P&L, equity curve, avg R:R, max drawdown
- Phân tích theo ngành/direction, so sánh AI score cao vs thấp
- Streak tracking, calendar heatmap view
- Telegram thông báo khi lệnh hit TP/SL
