...
(Defining requirements for v9.0)

## Current Milestone: v9.0 UX Rework & Simplification

**Goal:** Đơn giản hóa Holo — bỏ features không cần (corporate events, HNX/UPCOM), redesign luồng sử dụng cho rõ ràng, cải thiện AI output dài và hữu ích hơn.

**Target features:**
- Remove corporate events (backend + frontend + DB)
- Remove HNX & UPCOM support (chỉ giữ HOSE)
- Cải thiện AI analysis — phân tích dài hơn, rõ ràng hơn
- Redesign Trade Journal flow — next step rõ ràng sau khi ghi nhận
- Rework Coach page — cho phép thao tác được, không chỉ hiển thị
- Watchlist rework — chuyển từ localStorage sang DB, làm rõ giá trị
- Cải thiện navigation & onboarding — user biết bắt đầu từ đâu
