...
## Current Milestone: v16.0 Real-Time Price (IN PROGRESS)

**Goal:** Kết nối VNDirect WebSocket để nhận giá cổ phiếu real-time trong giờ giao dịch, broadcast tới frontend dashboard với flash animation và live candlestick updates.

**Key technical:** VNDirect WebSocket endpoint `wss://price-cmc-04.vndirect.com.vn/realtime/websocket` (free, no auth). Message types: SP (Stock Price), BA (Bid/Ask).
