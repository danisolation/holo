...
(v14.0 — see Current Milestone below)

## Current Milestone: v14.0 Multi-Source Rumor & Quota Fix

**Goal:** Mở rộng nguồn tin đồn (thêm VnExpress, Vietstock, Stockbiz) và fix Gemini quota để rumor scoring hoạt động.

**Target features:**
- Đổi Gemini model cho rumor scoring sang gemini-2.0-flash (1500 RPD free tier)
- Crawler VnExpress chứng khoán (RSS/scraping)
- Crawler Vietstock.vn tin tức tài chính
- Crawler Stockbiz.vn tin tổng hợp
- Tích hợp tất cả nguồn mới vào rumor scoring pipeline
- Cập nhật scheduler chain để chạy tất cả crawlers

## Previous Milestone: v13.0 AI Context & Accuracy (SHIPPED)

**Goal:** Cải thiện chất lượng AI bằng cách tích hợp rumor scores vào analysis pipeline, theo dõi accuracy của AI recommendations, và thêm volume/sector context vào Gemini prompts.

**Target features:**
- Rumor score fed into combined analysis + trading signals + daily picks
- AI accuracy tracking (1d/3d/7d price verification after signals)
- Accuracy dashboard with trend chart
- Volume profile + sector peer comparison in Gemini prompts
