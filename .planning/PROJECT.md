...
## Current Milestone: v25.0 AI Simulator Split

**Goal:** Tách simulator thành 2 portfolio riêng biệt (AI tự động + User thủ công), thêm AI rationale/review, và so sánh hiệu suất AI vs User.

**Target features:**
- Dual Portfolio — 2 portfolio độc lập: AI portfolio (auto-trade) + User portfolio (manual)
- AI Rationale — giải thích tại sao mỗi signal được đề xuất
- AI Portfolio Review — phân tích điểm mạnh/yếu, gợi ý cải thiện
- AI Post-Trade Review — phân tích lệnh đã thực hiện, tìm pattern lỗi
- Performance Comparison — so sánh AI vs User (equity chart, win rate, P&L)
