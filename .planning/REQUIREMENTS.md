...
- [ ] **PORT-08**: User can see dividend income on held positions when corporate events have matching record dates
- [ ] **PORT-09**: User can view portfolio total value over time as a line chart
- [ ] **PORT-10**: User can view portfolio allocation as a pie chart by ticker or by sector
