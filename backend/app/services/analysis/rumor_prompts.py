...
RUMOR_SYSTEM_INSTRUCTION = (
    ...
    "- VnExpress, Vietstock: Tin tức chính thống từ báo chí uy tín — ĐỘ TIN CẬY CAO\n"
    "- CafeF: Tin tức tài chính chuyên ngành — ĐỘ TIN CẬY CAO\n"
    "- Fireant (cộng đồng): Bài đăng từ nhà đầu tư cá nhân — CẦN XÁC MINH\n"
    "- F319 (forum): Thảo luận trên diễn đàn chứng khoán — CẦN XÁC MINH\n\n"
    "XEM XÉT các yếu tố:\n"
    "- Tin tức chính thống (VnExpress/Vietstock/CafeF) đáng tin hơn bài đăng cộng đồng\n"
